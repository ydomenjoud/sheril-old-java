...
public class ObjetSimpleTransporte extends ObjetTransporte implements
	...
	public void setNombre(int entree) {
		nombre = entree;
	}

	public void ajoutNombre(int nb) {
		nombre = nombre + nb;
	}

	public Object ajout(Object o) {
		if (o != null)
			nombre = nombre + ((ObjetSimpleTransporte) o).getNombre();
		return this;
	}
	...
	public Object clone() {
		return new ObjetSimpleTransporte(getCode(), getNombre());
	}
