...
public class RapportXML {
	...
	public RapportXML(Commandant commandant) {
		this(commandant, false);
	}

	public RapportXML(Commandant commandant, boolean uniquementDetections) {
	...
	public void ecrireRapportXML() {
		ecrireRapportXML(null);
	}
	public void ecrireRapportXML(String overloadChemin) {
		if(overloadChemin != null){
			chemin = overloadChemin;
		}
		try {
