...
//SECTION SPECIALE
 ...
 public static final Batiment extraI  = new Batiment("extra",0,ListeParents.extraI,3000,ListeCaracSpeciales.extraI,2,50F,ListeMarchandises.extraI,200,10,null);
 public static final Batiment extraII = new Batiment("extra",1,ListeParents.extraII,5000,ListeCaracSpeciales.extraII,4,100F,ListeMarchandises.extraII,200,15,null);
...
public static final Batiment agroII=new Batiment("agro",1,ListeParents.agroII,200,ListeCaracSpeciales.agroII,19,190F,ListeMarchandises.agroII,100,5,null);
public static final Batiment agroIII=new Batiment("agro",2,ListeParents.agroIII,500,ListeCaracSpeciales.agroIII,27,270F,ListeMarchandises.agroIII,100,5,null);
public static final Batiment agroIV=new Batiment("agro",3,ListeParents.agroIV,1000,ListeCaracSpeciales.agroIV,34,340F,ListeMarchandises.agroIV,100,5,null);
public static final Batiment agroV=new Batiment("agro",4,ListeParents.agroV,1700,ListeCaracSpeciales.agroV,40,400F,ListeMarchandises.agroV,100,5,null);
public static final Batiment agroVI=new Batiment("agro",5,ListeParents.agroVI,2600,ListeCaracSpeciales.agroVI,45,450F,ListeMarchandises.agroVI,100,5,null);
public static final Batiment agroVII=new Batiment("agro",6,ListeParents.agroVII,3700,ListeCaracSpeciales.agroVII,49,490F,ListeMarchandises.agroVII,100,5,null);
public static final Batiment agroVIII=new Batiment("agro",7,ListeParents.agroVIII,5000,ListeCaracSpeciales.agroVIII,52,520F,ListeMarchandises.agroVIII,100,5,null);
public static final Batiment agroIX=new Batiment("agro",8,ListeParents.agroIX,6500,ListeCaracSpeciales.agroIX,54,540F,ListeMarchandises.agroIX,100,5,null);
public static final Batiment agroX=new Batiment("agro",9,ListeParents.agroX,8200,ListeCaracSpeciales.agroX,55,550F,ListeMarchandises.agroX,100,5,null);
...
public static final Batiment agricoleII=new Batiment("agricole",1,ListeParents.agricoleII,200,ListeCaracSpeciales.agricoleII,19,190F,ListeMarchandises.agricoleII,100,5,null);
public static final Batiment agricoleIII=new Batiment("agricole",2,ListeParents.agricoleIII,500,ListeCaracSpeciales.agricoleIII,27,270F,ListeMarchandises.agricoleIII,100,5,null);
public static final Batiment agricoleIV=new Batiment("agricole",3,ListeParents.agricoleIV,1000,ListeCaracSpeciales.agricoleIV,34,340F,ListeMarchandises.agricoleIV,100,5,null);
public static final Batiment agricoleV=new Batiment("agricole",4,ListeParents.agricoleV,1700,ListeCaracSpeciales.agricoleV,40,400F,ListeMarchandises.agricoleV,100,5,null);
public static final Batiment agricoleVI=new Batiment("agricole",5,ListeParents.agricoleVI,2600,ListeCaracSpeciales.agricoleVI,45,450F,ListeMarchandises.agricoleVI,100,5,null);
public static final Batiment agricoleVII=new Batiment("agricole",6,ListeParents.agricoleVII,3700,ListeCaracSpeciales.agricoleVII,49,490F,ListeMarchandises.agricoleVII,100,5,null);
public static final Batiment agricoleVIII=new Batiment("agricole",7,ListeParents.agricoleVIII,5000,ListeCaracSpeciales.agricoleVIII,52,520F,ListeMarchandises.agricoleVIII,100,5,null);
public static final Batiment agricoleIX=new Batiment("agricole",8,ListeParents.agricoleIX,6500,ListeCaracSpeciales.agricoleIX,54,540F,ListeMarchandises.agricoleIX,100,5,null);
public static final Batiment agricoleX=new Batiment("agricole",9,ListeParents.agricoleX,8200,ListeCaracSpeciales.agricoleX,55,550F,ListeMarchandises.agricoleX,100,5,null);
...
public static final Batiment modeII=new Batiment("mode",1,ListeParents.modeII,200,ListeCaracSpeciales.modeII,19,190F,ListeMarchandises.modeII,100,5,null);
public static final Batiment modeIII=new Batiment("mode",2,ListeParents.modeIII,500,ListeCaracSpeciales.modeIII,27,270F,ListeMarchandises.modeIII,100,5,null);
public static final Batiment modeIV=new Batiment("mode",3,ListeParents.modeIV,1000,ListeCaracSpeciales.modeIV,34,340F,ListeMarchandises.modeIV,100,5,null);
public static final Batiment modeV=new Batiment("mode",4,ListeParents.modeV,1700,ListeCaracSpeciales.modeV,40,400F,ListeMarchandises.modeV,100,5,null);
public static final Batiment modeVI=new Batiment("mode",5,ListeParents.modeVI,2600,ListeCaracSpeciales.modeVI,45,450F,ListeMarchandises.modeVI,100,5,null);
public static final Batiment modeVII=new Batiment("mode",6,ListeParents.modeVII,3700,ListeCaracSpeciales.modeVII,49,490F,ListeMarchandises.modeVII,100,5,null);
public static final Batiment modeVIII=new Batiment("mode",7,ListeParents.modeVIII,5000,ListeCaracSpeciales.modeVIII,52,520F,ListeMarchandises.modeVIII,100,5,null);
public static final Batiment modeIX=new Batiment("mode",8,ListeParents.modeIX,6500,ListeCaracSpeciales.modeIX,54,540F,ListeMarchandises.modeIX,100,5,null);
public static final Batiment modeX=new Batiment("mode",9,ListeParents.modeX,8200,ListeCaracSpeciales.modeX,55,550F,ListeMarchandises.modeX,100,5,null);
...
public static final Batiment culturelII=new Batiment("culturel",1,ListeParents.culturelII,200,ListeCaracSpeciales.culturelII,19,190F,ListeMarchandises.culturelII,100,5,null);
public static final Batiment culturelIII=new Batiment("culturel",2,ListeParents.culturelIII,500,ListeCaracSpeciales.culturelIII,27,270F,ListeMarchandises.culturelIII,100,5,null);
public static final Batiment culturelIV=new Batiment("culturel",3,ListeParents.culturelIV,1000,ListeCaracSpeciales.culturelIV,34,340F,ListeMarchandises.culturelIV,100,5,null);
public static final Batiment culturelV=new Batiment("culturel",4,ListeParents.culturelV,1700,ListeCaracSpeciales.culturelV,40,400F,ListeMarchandises.culturelV,100,5,null);
public static final Batiment culturelVI=new Batiment("culturel",5,ListeParents.culturelVI,2600,ListeCaracSpeciales.culturelVI,45,450F,ListeMarchandises.culturelVI,100,5,null);
public static final Batiment culturelVII=new Batiment("culturel",6,ListeParents.culturelVII,3700,ListeCaracSpeciales.culturelVII,49,490F,ListeMarchandises.culturelVII,100,5,null);
public static final Batiment culturelVIII=new Batiment("culturel",7,ListeParents.culturelVIII,5000,ListeCaracSpeciales.culturelVIII,52,520F,ListeMarchandises.culturelVIII,100,5,null);
public static final Batiment culturelIX=new Batiment("culturel",8,ListeParents.culturelIX,6500,ListeCaracSpeciales.culturelIX,54,540F,ListeMarchandises.culturelIX,100,5,null);
public static final Batiment culturelX=new Batiment("culturel",9,ListeParents.culturelX,8200,ListeCaracSpeciales.culturelX,55,550F,ListeMarchandises.culturelX,100,5,null);
...
public static final Batiment transfoII=new Batiment("transfo",1,ListeParents.transfoII,200,ListeCaracSpeciales.transfoII,19,190F,ListeMarchandises.transfoII,100,5,null);
public static final Batiment transfoIII=new Batiment("transfo",2,ListeParents.transfoIII,500,ListeCaracSpeciales.transfoIII,27,270F,ListeMarchandises.transfoIII,100,5,null);
public static final Batiment transfoIV=new Batiment("transfo",3,ListeParents.transfoIV,1000,ListeCaracSpeciales.transfoIV,34,340F,ListeMarchandises.transfoIV,100,5,null);
public static final Batiment transfoV=new Batiment("transfo",4,ListeParents.transfoV,1700,ListeCaracSpeciales.transfoV,40,400F,ListeMarchandises.transfoV,100,5,null);
public static final Batiment transfoVI=new Batiment("transfo",5,ListeParents.transfoVI,2600,ListeCaracSpeciales.transfoVI,45,450F,ListeMarchandises.transfoVI,100,5,null);
public static final Batiment transfoVII=new Batiment("transfo",6,ListeParents.transfoVII,3700,ListeCaracSpeciales.transfoVII,49,490F,ListeMarchandises.transfoVII,100,5,null);
public static final Batiment transfoVIII=new Batiment("transfo",7,ListeParents.transfoVIII,5000,ListeCaracSpeciales.transfoVIII,52,520F,ListeMarchandises.transfoVIII,100,5,null);
public static final Batiment transfoIX=new Batiment("transfo",8,ListeParents.transfoIX,6500,ListeCaracSpeciales.transfoIX,54,540F,ListeMarchandises.transfoIX,100,5,null);
public static final Batiment transfoX=new Batiment("transfo",9,ListeParents.transfoX,8200,ListeCaracSpeciales.transfoX,55,550F,ListeMarchandises.transfoX,100,5,null);
...
public static final Batiment pharmaII=new Batiment("pharma",1,ListeParents.pharmaII,200,ListeCaracSpeciales.pharmaII,19,190F,ListeMarchandises.pharmaII,100,5,null);
public static final Batiment pharmaIII=new Batiment("pharma",2,ListeParents.pharmaIII,500,ListeCaracSpeciales.pharmaIII,27,270F,ListeMarchandises.pharmaIII,100,5,null);
public static final Batiment pharmaIV=new Batiment("pharma",3,ListeParents.pharmaIV,1000,ListeCaracSpeciales.pharmaIV,34,340F,ListeMarchandises.pharmaIV,100,5,null);
public static final Batiment pharmaV=new Batiment("pharma",4,ListeParents.pharmaV,1700,ListeCaracSpeciales.pharmaV,40,400F,ListeMarchandises.pharmaV,100,5,null);
public static final Batiment pharmaVI=new Batiment("pharma",5,ListeParents.pharmaVI,2600,ListeCaracSpeciales.pharmaVI,45,450F,ListeMarchandises.pharmaVI,100,5,null);
public static final Batiment pharmaVII=new Batiment("pharma",6,ListeParents.pharmaVII,3700,ListeCaracSpeciales.pharmaVII,49,490F,ListeMarchandises.pharmaVII,100,5,null);
public static final Batiment pharmaVIII=new Batiment("pharma",7,ListeParents.pharmaVIII,5000,ListeCaracSpeciales.pharmaVIII,52,520F,ListeMarchandises.pharmaVIII,100,5,null);
public static final Batiment pharmaIX=new Batiment("pharma",8,ListeParents.pharmaIX,6500,ListeCaracSpeciales.pharmaIX,54,540F,ListeMarchandises.pharmaIX,100,5,null);
public static final Batiment pharmaX=new Batiment("pharma",9,ListeParents.pharmaX,8200,ListeCaracSpeciales.pharmaX,55,550F,ListeMarchandises.pharmaX,100,5,null);
...
public static final Batiment infoII=new Batiment("info",1,ListeParents.infoII,200,ListeCaracSpeciales.infoII,19,190F,ListeMarchandises.infoII,100,5,null);
public static final Batiment infoIII=new Batiment("info",2,ListeParents.infoIII,500,ListeCaracSpeciales.infoIII,27,270F,ListeMarchandises.infoIII,100,5,null);
public static final Batiment infoIV=new Batiment("info",3,ListeParents.infoIV,1000,ListeCaracSpeciales.infoIV,34,340F,ListeMarchandises.infoIV,100,5,null);
public static final Batiment infoV=new Batiment("info",4,ListeParents.infoV,1700,ListeCaracSpeciales.infoV,40,400F,ListeMarchandises.infoV,100,5,null);
public static final Batiment infoVI=new Batiment("info",5,ListeParents.infoVI,2600,ListeCaracSpeciales.infoVI,45,450F,ListeMarchandises.infoVI,100,5,null);
public static final Batiment infoVII=new Batiment("info",6,ListeParents.infoVII,3700,ListeCaracSpeciales.infoVII,49,490F,ListeMarchandises.infoVII,100,5,null);
public static final Batiment infoVIII=new Batiment("info",7,ListeParents.infoVIII,5000,ListeCaracSpeciales.infoVIII,52,520F,ListeMarchandises.infoVIII,100,5,null);
public static final Batiment infoIX=new Batiment("info",8,ListeParents.infoIX,6500,ListeCaracSpeciales.infoIX,54,540F,ListeMarchandises.infoIX,100,5,null);
public static final Batiment infoX=new Batiment("info",9,ListeParents.infoX,8200,ListeCaracSpeciales.infoX,55,550F,ListeMarchandises.infoX,100,5,null);
...
public static final Batiment robotII=new Batiment("robot",1,ListeParents.robotII,200,ListeCaracSpeciales.robotII,19,190F,ListeMarchandises.robotII,100,5,null);
public static final Batiment robotIII=new Batiment("robot",2,ListeParents.robotIII,500,ListeCaracSpeciales.robotIII,27,270F,ListeMarchandises.robotIII,100,5,null);
public static final Batiment robotIV=new Batiment("robot",3,ListeParents.robotIV,1000,ListeCaracSpeciales.robotIV,34,340F,ListeMarchandises.robotIV,100,5,null);
public static final Batiment robotV=new Batiment("robot",4,ListeParents.robotV,1700,ListeCaracSpeciales.robotV,40,400F,ListeMarchandises.robotV,100,5,null);
public static final Batiment robotVI=new Batiment("robot",5,ListeParents.robotVI,2600,ListeCaracSpeciales.robotVI,45,450F,ListeMarchandises.robotVI,100,5,null);
public static final Batiment robotVII=new Batiment("robot",6,ListeParents.robotVII,3700,ListeCaracSpeciales.robotVII,49,490F,ListeMarchandises.robotVII,100,5,null);
public static final Batiment robotVIII=new Batiment("robot",7,ListeParents.robotVIII,5000,ListeCaracSpeciales.robotVIII,52,520F,ListeMarchandises.robotVIII,100,5,null);
public static final Batiment robotIX=new Batiment("robot",8,ListeParents.robotIX,6500,ListeCaracSpeciales.robotIX,54,540F,ListeMarchandises.robotIX,100,5,null);
public static final Batiment robotX=new Batiment("robot",9,ListeParents.robotX,8200,ListeCaracSpeciales.robotX,55,550F,ListeMarchandises.robotX,100,5,null);
...
public static final Batiment technoII=new Batiment("techno",1,ListeParents.technoII,200,ListeCaracSpeciales.technoII,19,190F,ListeMarchandises.technoII,100,5,null);
public static final Batiment technoIII=new Batiment("techno",2,ListeParents.technoIII,500,ListeCaracSpeciales.technoIII,27,270F,ListeMarchandises.technoIII,100,5,null);
public static final Batiment technoIV=new Batiment("techno",3,ListeParents.technoIV,1000,ListeCaracSpeciales.technoIV,34,340F,ListeMarchandises.technoIV,100,5,null);
public static final Batiment technoV=new Batiment("techno",4,ListeParents.technoV,1700,ListeCaracSpeciales.technoV,40,400F,ListeMarchandises.technoV,100,5,null);
public static final Batiment technoVI=new Batiment("techno",5,ListeParents.technoVI,2600,ListeCaracSpeciales.technoVI,45,450F,ListeMarchandises.technoVI,100,5,null);
public static final Batiment technoVII=new Batiment("techno",6,ListeParents.technoVII,3700,ListeCaracSpeciales.technoVII,49,490F,ListeMarchandises.technoVII,100,5,null);
public static final Batiment technoVIII=new Batiment("techno",7,ListeParents.technoVIII,5000,ListeCaracSpeciales.technoVIII,52,520F,ListeMarchandises.technoVIII,100,5,null);
public static final Batiment technoIX=new Batiment("techno",8,ListeParents.technoIX,6500,ListeCaracSpeciales.technoIX,54,540F,ListeMarchandises.technoIX,100,5,null);
public static final Batiment technoX=new Batiment("techno",9,ListeParents.technoX,8200,ListeCaracSpeciales.technoX,55,550F,ListeMarchandises.technoX,100,5,null);
...
public static final Batiment armeII=new Batiment("arme",1,ListeParents.armeII,200,ListeCaracSpeciales.armeII,19,190F,ListeMarchandises.armeII,100,5,null);
public static final Batiment armeIII=new Batiment("arme",2,ListeParents.armeIII,500,ListeCaracSpeciales.armeIII,27,270F,ListeMarchandises.armeIII,100,5,null);
public static final Batiment armeIV=new Batiment("arme",3,ListeParents.armeIV,1000,ListeCaracSpeciales.armeIV,34,340F,ListeMarchandises.armeIV,100,5,null);
public static final Batiment armeV=new Batiment("arme",4,ListeParents.armeV,1700,ListeCaracSpeciales.armeV,40,400F,ListeMarchandises.armeV,100,5,null);
public static final Batiment armeVI=new Batiment("arme",5,ListeParents.armeVI,2600,ListeCaracSpeciales.armeVI,45,450F,ListeMarchandises.armeVI,100,5,null);
public static final Batiment armeVII=new Batiment("arme",6,ListeParents.armeVII,3700,ListeCaracSpeciales.armeVII,49,490F,ListeMarchandises.armeVII,100,5,null);
public static final Batiment armeVIII=new Batiment("arme",7,ListeParents.armeVIII,5000,ListeCaracSpeciales.armeVIII,52,520F,ListeMarchandises.armeVIII,100,5,null);
public static final Batiment armeIX=new Batiment("arme",8,ListeParents.armeIX,6500,ListeCaracSpeciales.armeIX,54,540F,ListeMarchandises.armeIX,100,5,null);
public static final Batiment armeX=new Batiment("arme",9,ListeParents.armeX,8200,ListeCaracSpeciales.armeX,55,550F,ListeMarchandises.armeX,100,5,null);
...
public static final Batiment raffineII=new Batiment("raffine",1,ListeParents.raffineII,200,ListeCaracSpeciales.raffineII,19,190F,ListeMarchandises.raffineII,100,5,null);
public static final Batiment raffineIII=new Batiment("raffine",2,ListeParents.raffineIII,500,ListeCaracSpeciales.raffineIII,27,270F,ListeMarchandises.raffineIII,100,5,null);
public static final Batiment raffineIV=new Batiment("raffine",3,ListeParents.raffineIV,1000,ListeCaracSpeciales.raffineIV,34,340F,ListeMarchandises.raffineIV,100,5,null);
public static final Batiment raffineV=new Batiment("raffine",4,ListeParents.raffineV,1700,ListeCaracSpeciales.raffineV,40,400F,ListeMarchandises.raffineV,100,5,null);
public static final Batiment raffineVI=new Batiment("raffine",5,ListeParents.raffineVI,2600,ListeCaracSpeciales.raffineVI,45,450F,ListeMarchandises.raffineVI,100,5,null);
public static final Batiment raffineVII=new Batiment("raffine",6,ListeParents.raffineVII,3700,ListeCaracSpeciales.raffineVII,49,490F,ListeMarchandises.raffineVII,100,5,null);
public static final Batiment raffineVIII=new Batiment("raffine",7,ListeParents.raffineVIII,5000,ListeCaracSpeciales.raffineVIII,52,520F,ListeMarchandises.raffineVIII,100,5,null);
public static final Batiment raffineIX=new Batiment("raffine",8,ListeParents.raffineIX,6500,ListeCaracSpeciales.raffineIX,54,540F,ListeMarchandises.raffineIX,100,5,null);
public static final Batiment raffineX=new Batiment("raffine",9,ListeParents.raffineX,8200,ListeCaracSpeciales.raffineX,55,550F,ListeMarchandises.raffineX,100,5,null);
...
public static final Batiment lourdeII=new Batiment("lourde",1,ListeParents.lourdeII,200,ListeCaracSpeciales.lourdeII,19,190F,ListeMarchandises.lourdeII,100,5,null);
public static final Batiment lourdeIII=new Batiment("lourde",2,ListeParents.lourdeIII,500,ListeCaracSpeciales.lourdeIII,27,270F,ListeMarchandises.lourdeIII,100,5,null);
public static final Batiment lourdeIV=new Batiment("lourde",3,ListeParents.lourdeIV,1000,ListeCaracSpeciales.lourdeIV,34,340F,ListeMarchandises.lourdeIV,100,5,null);
public static final Batiment lourdeV=new Batiment("lourde",4,ListeParents.lourdeV,1700,ListeCaracSpeciales.lourdeV,40,400F,ListeMarchandises.lourdeV,100,5,null);
public static final Batiment lourdeVI=new Batiment("lourde",5,ListeParents.lourdeVI,2600,ListeCaracSpeciales.lourdeVI,45,450F,ListeMarchandises.lourdeVI,100,5,null);
public static final Batiment lourdeVII=new Batiment("lourde",6,ListeParents.lourdeVII,3700,ListeCaracSpeciales.lourdeVII,49,490F,ListeMarchandises.lourdeVII,100,5,null);
public static final Batiment lourdeVIII=new Batiment("lourde",7,ListeParents.lourdeVIII,5000,ListeCaracSpeciales.lourdeVIII,52,520F,ListeMarchandises.lourdeVIII,100,5,null);
public static final Batiment lourdeIX=new Batiment("lourde",8,ListeParents.lourdeIX,6500,ListeCaracSpeciales.lourdeIX,54,540F,ListeMarchandises.lourdeIX,100,5,null);
public static final Batiment lourdeX=new Batiment("lourde",9,ListeParents.lourdeX,8200,ListeCaracSpeciales.lourdeX,55,550F,ListeMarchandises.lourdeX,100,5,null);
...
public static final Batiment metauxII=new Batiment("metaux",1,ListeParents.metauxII,200,ListeCaracSpeciales.metauxII,19,190F,ListeMarchandises.metauxII,100,5,null);
public static final Batiment metauxIII=new Batiment("metaux",2,ListeParents.metauxIII,500,ListeCaracSpeciales.metauxIII,27,270F,ListeMarchandises.metauxIII,100,5,null);
public static final Batiment metauxIV=new Batiment("metaux",3,ListeParents.metauxIV,1000,ListeCaracSpeciales.metauxIV,34,340F,ListeMarchandises.metauxIV,100,5,null);
public static final Batiment metauxV=new Batiment("metaux",4,ListeParents.metauxV,1700,ListeCaracSpeciales.metauxV,40,400F,ListeMarchandises.metauxV,100,5,null);
public static final Batiment metauxVI=new Batiment("metaux",5,ListeParents.metauxVI,2600,ListeCaracSpeciales.metauxVI,45,450F,ListeMarchandises.metauxVI,100,5,null);
public static final Batiment metauxVII=new Batiment("metaux",6,ListeParents.metauxVII,3700,ListeCaracSpeciales.metauxVII,49,490F,ListeMarchandises.metauxVII,100,5,null);
public static final Batiment metauxVIII=new Batiment("metaux",7,ListeParents.metauxVIII,5000,ListeCaracSpeciales.metauxVIII,52,520F,ListeMarchandises.metauxVIII,100,5,null);
public static final Batiment metauxIX=new Batiment("metaux",8,ListeParents.metauxIX,6500,ListeCaracSpeciales.metauxIX,54,540F,ListeMarchandises.metauxIX,100,5,null);
public static final Batiment metauxX=new Batiment("metaux",9,ListeParents.metauxX,8200,ListeCaracSpeciales.metauxX,55,550F,ListeMarchandises.metauxX,100,5,null);
...
public static final Batiment poly_popV   = new Batiment("poly_pop", 4, ListeParents.poly_popV,  100, ListeCaracSpeciales.poly_popV,    10, 6000F, ListeMarchandises.poly_popV,   300, 25, null);
 ...
 public static final Batiment battlaII=new Batiment("battla",1,ListeParents.battlaII,200,null,5,150F,ListeMarchandises.battlaII,50,5,"laser");
 public static final Batiment battlaIII=new Batiment("battla",2,ListeParents.battlaIII,400,null,10,200F,ListeMarchandises.battlaIII,100,5,"laser");
 public static final Batiment battlaIV=new Batiment("battla",3,ListeParents.battlaIV,800,null,10,250F,ListeMarchandises.battlaIV,150,5,"laser");
 public static final Batiment battlaV=new Batiment("battla",4,ListeParents.battlaV,1600,null,15,300F,ListeMarchandises.battlaV,200,5,"laser");
 public static final Batiment battlaVI=new Batiment("battla",5,ListeParents.battlaVI,3000,null,15,350F,ListeMarchandises.battlaVI,250,5,"laser");
 public static final Batiment battlaVII=new Batiment("battla",6,ListeParents.battlaVII,5000,null,20,400F,ListeMarchandises.battlaVII,300,5,"laser");
 public static final Batiment battlaVIII=new Batiment("battla",7,ListeParents.battlaVIII,10000,null,20,450F,ListeMarchandises.battlaVIII,350,5,"laser");
 public static final Batiment battlaIX=new Batiment("battla",8,ListeParents.battlaIX,15000,null,25,500F,ListeMarchandises.battlaIX,400,5,"laser");
 public static final Batiment battlaX=new Batiment("battla",9,ListeParents.battlaX,30000,null,30,550F,ListeMarchandises.battlaX,450,5,"laser");

 public static final Batiment battplaI=new Batiment("battpla",0,ListeParents.battplaI,100,null,5,80F,null,25,5,"plasma");
 public static final Batiment battplaII=new Batiment("battpla",1,ListeParents.battplaII,200,null,5,150F,ListeMarchandises.battplaII,50,5,"plasma");
 public static final Batiment battplaIII=new Batiment("battpla",2,ListeParents.battplaIII,400,null,10,200F,ListeMarchandises.battplaIII,100,5,"plasma");
 public static final Batiment battplaIV=new Batiment("battpla",3,ListeParents.battplaIV,800,null,10,250F,ListeMarchandises.battplaIV,150,5,"plasma");
 public static final Batiment battplaV=new Batiment("battpla",4,ListeParents.battplaV,1600,null,15,300F,ListeMarchandises.battplaV,200,5,"plasma");
 public static final Batiment battplaVI=new Batiment("battpla",5,ListeParents.battplaVI,3000,null,15,350F,ListeMarchandises.battplaVI,250,5,"plasma");
 public static final Batiment battplaVII=new Batiment("battpla",6,ListeParents.battplaVII,5000,null,20,400F,ListeMarchandises.battplaVII,300,5,"plasma");
 public static final Batiment battplaVIII=new Batiment("battpla",7,ListeParents.battplaVIII,10000,null,20,450F,ListeMarchandises.battplaVIII,350,5,"plasma");
 public static final Batiment battplaIX=new Batiment("battpla",8,ListeParents.battplaIX,15000,null,25,500F,ListeMarchandises.battplaIX,400,5,"plasma");
 public static final Batiment battplaX=new Batiment("battpla",9,ListeParents.battplaX,30000,null,30,550F,ListeMarchandises.battplaX,500,5,"plasma");

 public static final Batiment rampemisI=new Batiment("rampemis",0,ListeParents.rampemisI,100,null,5,80F,null,25,5,"miss");
 public static final Batiment rampemisII=new Batiment("rampemis",1,ListeParents.rampemisII,200,null,5,150F,ListeMarchandises.rampemisII,50,5,"miss");
 public static final Batiment rampemisIII=new Batiment("rampemis",2,ListeParents.rampemisIII,400,null,10,200F,ListeMarchandises.rampemisIII,100,5,"miss");
 public static final Batiment rampemisIV=new Batiment("rampemis",3,ListeParents.rampemisIV,800,null,10,250F,ListeMarchandises.rampemisIV,150,5,"miss");
 public static final Batiment rampemisV=new Batiment("rampemis",4,ListeParents.rampemisV,1600,null,15,300F,ListeMarchandises.rampemisV,200,5,"miss");
 public static final Batiment rampemisVI=new Batiment("rampemis",5,ListeParents.rampemisVI,3000,null,15,350F,ListeMarchandises.rampemisVI,250,5,"miss");
 public static final Batiment rampemisVII=new Batiment("rampemis",6,ListeParents.rampemisVII,5000,null,20,400F,ListeMarchandises.rampemisVII,300,5,"miss");
 public static final Batiment rampemisVIII=new Batiment("rampemis",7,ListeParents.rampemisVIII,10000,null,20,450F,ListeMarchandises.rampemisVIII,350,5,"miss");
 public static final Batiment rampemisIX=new Batiment("rampemis",8,ListeParents.rampemisIX,15000,null,25,500F,ListeMarchandises.rampemisIX,400,5,"miss");
 public static final Batiment rampemisX=new Batiment("rampemis",9,ListeParents.rampemisX,30000,null,30,550F,ListeMarchandises.rampemisX,500,5,"miss");
 ...
 public static final Batiment lancetorIII=new Batiment("lancetor",2,ListeParents.lancetorIII,400,null,10,200F,ListeMarchandises.lancetorIII,100,5,"torp");
 public static final Batiment lancetorIV=new Batiment("lancetor",3,ListeParents.lancetorIV,800,null,10,250F,ListeMarchandises.lancetorIV,150,5,"torp");
 public static final Batiment lancetorV=new Batiment("lancetor",4,ListeParents.lancetorV,1600,null,15,300F,ListeMarchandises.lancetorV,200,5,"torp");
 public static final Batiment lancetorVI=new Batiment("lancetor",5,ListeParents.lancetorVI,3000,null,15,350F,ListeMarchandises.lancetorVI,250,5,"torp");
 public static final Batiment lancetorVII=new Batiment("lancetor",6,ListeParents.lancetorVII,5000,null,20,400F,ListeMarchandises.lancetorVII,300,5,"torp");
 public static final Batiment lancetorVIII=new Batiment("lancetor",7,ListeParents.lancetorVIII,10000,null,20,450F,ListeMarchandises.lancetorVIII,350,5,"torp");
 public static final Batiment lancetorIX=new Batiment("lancetor",8,ListeParents.lancetorIX,15000,null,25,500F,ListeMarchandises.lancetorIX,400,5,"torp");
 public static final Batiment lancetorX=new Batiment("lancetor",9,ListeParents.lancetorX,30000,null,30,550F,ListeMarchandises.lancetorX,500,5,"torp");
