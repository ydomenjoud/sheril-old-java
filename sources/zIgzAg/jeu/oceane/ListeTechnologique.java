...
public static final Batiment poly_popV   = new Batiment("poly_pop", 4, ListeParents.poly_popV,  100, ListeCaracSpeciales.poly_popV,    10, 6000F, ListeMarchandises.poly_popV,   300, 25, null);
 ...
 public static final Batiment battlaIII=new Batiment("battla",2,ListeParents.battlaIII,400,null,5,200F,ListeMarchandises.battlaIII,100,10,"laser");
 ...
 public static final Batiment battlaV=new Batiment("battla",4,ListeParents.battlaV,1600,null,15,300F,ListeMarchandises.battlaV,200,10,"laser");
 public static final Batiment battlaVI=new Batiment("battla",5,ListeParents.battlaVI,3000,null,15,350F,ListeMarchandises.battlaVI,250,10,"laser");
 public static final Batiment battlaVII=new Batiment("battla",6,ListeParents.battlaVII,5000,null,15,400F,ListeMarchandises.battlaVII,300,10,"laser");
 public static final Batiment battlaVIII=new Batiment("battla",7,ListeParents.battlaVIII,10000,null,20,450F,ListeMarchandises.battlaVIII,350,10,"laser");
 public static final Batiment battlaIX=new Batiment("battla",8,ListeParents.battlaIX,15000,null,25,500F,ListeMarchandises.battlaIX,400,10,"laser");
 public static final Batiment battlaX=new Batiment("battla",9,ListeParents.battlaX,30000,null,30,550F,ListeMarchandises.battlaX,450,10,"laser");

 public static final Batiment battplaI=new Batiment("battpla",0,ListeParents.battplaI,100,null,5,80F,null,25,10,"plasma");
 ...
 public static final Batiment battplaIII=new Batiment("battpla",2,ListeParents.battplaIII,400,null,5,200F,ListeMarchandises.battplaIII,100,10,"plasma");
 ...
 public static final Batiment battplaV=new Batiment("battpla",4,ListeParents.battplaV,1600,null,15,300F,ListeMarchandises.battplaV,200,10,"plasma");
 public static final Batiment battplaVI=new Batiment("battpla",5,ListeParents.battplaVI,3000,null,15,350F,ListeMarchandises.battplaVI,250,10,"plasma");
 public static final Batiment battplaVII=new Batiment("battpla",6,ListeParents.battplaVII,5000,null,15,400F,ListeMarchandises.battplaVII,300,10,"plasma");
 public static final Batiment battplaVIII=new Batiment("battpla",7,ListeParents.battplaVIII,10000,null,20,450F,ListeMarchandises.battplaVIII,350,10,"plasma");
 public static final Batiment battplaIX=new Batiment("battpla",8,ListeParents.battplaIX,15000,null,25,500F,ListeMarchandises.battplaIX,400,10,"plasma");
 public static final Batiment battplaX=new Batiment("battpla",9,ListeParents.battplaX,30000,null,30,550F,ListeMarchandises.battplaX,500,10,"plasma");

 public static final Batiment rampemisI=new Batiment("rampemis",0,ListeParents.rampemisI,100,null,5,80F,null,25,10,"miss");
 ...
 public static final Batiment rampemisIII=new Batiment("rampemis",2,ListeParents.rampemisIII,400,null,5,200F,ListeMarchandises.rampemisIII,100,10,"miss");
 ...
 public static final Batiment rampemisV=new Batiment("rampemis",4,ListeParents.rampemisV,1600,null,15,300F,ListeMarchandises.rampemisV,200,10,"miss");
 public static final Batiment rampemisVI=new Batiment("rampemis",5,ListeParents.rampemisVI,3000,null,15,350F,ListeMarchandises.rampemisVI,250,10,"miss");
 public static final Batiment rampemisVII=new Batiment("rampemis",6,ListeParents.rampemisVII,5000,null,15,400F,ListeMarchandises.rampemisVII,300,10,"miss");
 public static final Batiment rampemisVIII=new Batiment("rampemis",7,ListeParents.rampemisVIII,10000,null,20,450F,ListeMarchandises.rampemisVIII,350,10,"miss");
 public static final Batiment rampemisIX=new Batiment("rampemis",8,ListeParents.rampemisIX,15000,null,25,500F,ListeMarchandises.rampemisIX,400,10,"miss");
 public static final Batiment rampemisX=new Batiment("rampemis",9,ListeParents.rampemisX,30000,null,30,550F,ListeMarchandises.rampemisX,500,10,"miss");

 public static final Batiment lancetorI=new Batiment("lancetor",0,ListeParents.lancetorI,100,null,5,80F,null,25,10,"torp");
 public static final Batiment lancetorII=new Batiment("lancetor",1,ListeParents.lancetorII,200,null,5,150F,ListeMarchandises.lancetorII,50,10,"torp");
 public static final Batiment lancetorIII=new Batiment("lancetor",2,ListeParents.lancetorIII,400,null,5,200F,ListeMarchandises.lancetorIII,100,10,"torp");
 ...
 public static final Batiment lancetorV=new Batiment("lancetor",4,ListeParents.lancetorV,1600,null,15,300F,ListeMarchandises.lancetorV,200,10,"torp");
 public static final Batiment lancetorVI=new Batiment("lancetor",5,ListeParents.lancetorVI,3000,null,15,350F,ListeMarchandises.lancetorVI,250,10,"torp");
 public static final Batiment lancetorVII=new Batiment("lancetor",6,ListeParents.lancetorVII,5000,null,15,400F,ListeMarchandises.lancetorVII,300,10,"torp");
 public static final Batiment lancetorVIII=new Batiment("lancetor",7,ListeParents.lancetorVIII,10000,null,20,450F,ListeMarchandises.lancetorVIII,350,10,"torp");
 public static final Batiment lancetorIX=new Batiment("lancetor",8,ListeParents.lancetorIX,15000,null,25,500F,ListeMarchandises.lancetorIX,400,10,"torp");
 public static final Batiment lancetorX=new Batiment("lancetor",9,ListeParents.lancetorX,30000,null,30,550F,ListeMarchandises.lancetorX,500,10,"torp");
