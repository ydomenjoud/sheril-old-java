 ...
 *    - 4 neutres proches (distance 1 à 2 cases)
 *    - 4 neutres éloignés (distance 3 à 4 cases)
 *    - Budget planétaire fixe du paquet (155 à 165 planètes au total).
 * 5. Systèmes neutres régionaux additionnels répartis dans chaque zone de Voronoï pour maximiser l'espacement.
 */
public class AjoutDeGalaxie {
    ...
    private static PaquetDepart creerPaquet(Position capitale, List capitales,
        ...
        // Le second système et 4 neutres occupent l'anneau proche ; 4 neutres occupent l'anneau extérieur.
    ...
    /**
     * Répartit équitablement le budget total de planètes du paquet (155-165)
     * entre la capitale et les 8 neutres, chacun recevant au moins 13 et au plus 20 planètes.
     */
    ...
    /**
     * Vérifie qu'une position appartient exclusivement au territoire de Voronoi de la capitale donnée
     * en comparant les distances toroïdales avec toutes les autres capitales.
     */
    ...
    /**
     * Sélectionne les positions candidates des systèmes régionaux en maximisant
     * leur distance toroïdale avec les systèmes déjà existants.
     */
