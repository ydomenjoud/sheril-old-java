...
public static final Description absorb=new Description("absorbeur","absorbeurs","L'absorbeur est un composant générant un puissant champ energétique à la surface même de la coque.<br />Il permet au vaisseau d'absorber un certain nombre de dommages par vaisseaux ennemis, se rechargeant après chaque salve.<br /> Plusieurs absorbeurs sur un même vaisseau n'ont pas d'effets cumulatifs.<br /> ");// armes de def
 ...
 public static final Description ville=new Description("ville spatiale","villes spatiales","Une ville spatiale est un composant de vaisseau.<br>Une ville spatiale est un espace de vie pour un nombre d'unités de population égal à sa caractéristique &quot;Capacité ville spatiale&quot;. La taxation de l'équipage  est de (niveau+2). Ainsi 2000 unités de population d'une Ville Spatiale niveau 3 rapportent: 2000 * (3+2) / 10 = 1000ce par tour. La population augmente de 1/10 de la population maximale par tour.");
 ...
 public static final Description recylage = new Description("unité de recyclage","unités de recyclage","Une unité de recyclage est un bâtiment .<br>Une unité de recyclage permet de récupérer le minerai de construction lors de la destruction d'un bâtiment.");
 ...
 public static final Description rampemis=new Description("batterie de missiles","rampes de missiles","Une batterie de missile permet de mieux défendre la planète sur laquelle elle est construite.");
 ...
 public static final Description maitmil = new Description("Maîtrise militaire","","Permet de diminuer le risque de collision entre vos vaisseaux. Potentiel = (N / ( 45 + 5*R)) - 2*M, si Potentiel > 0 : dégats collision = Potentiel² , où N=nombre de vaisseaux, R=nombre aléatoire entre 0 et 5, M=Niveau de maîtrise militaire ");
 ...
 public static final Description maitstargate = new Description("Maîtrise des étoiles","","Permet d'accroître le débit de vos portes spatiales. Un transfert supplémentaire par niveau de maîtrise.");
