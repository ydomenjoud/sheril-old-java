...
public static final Description absorb=new Description("absorbeur","absorbeurs","L'absorbeur est un composant générant un puissant champ energétique à la surface même de la coque.<br />Il permet au vaisseau d'absorber un certain nombre de dommages par vaisseaux ennemis, se rechargeant après chaque salve.<br /> Plusieurs absorbeurs sur un même vaisseau n'ont pas d'effets cumulatifs.<br /> ");// armes de def
 ...
 public static final Description agro=new Description("complexe agro-alimentaire","complexes agro-alimentaires","Un complexe agro-alimentaire procure (5 fois le niveau de l'usine ) unités de produits alimentaires par tour.");
 public static final Description agricole=new Description("usine agricole","usines agricoles","Une usine agricole procure (5 fois le niveau de l'usine )  unités de materiel agricole par tour.");
 public static final Description mode=new Description("centre de mode","centres de mode","Un centre de mode procure (5 fois le niveau de l'usine ) unités de produits de luxe par tour.");
 public static final Description culturel=new Description("centre culturel","centres culturels","Un centre culturel procure (5 fois le niveau de l'usine )  unités de holofilms et hololivres par tour.");
 public static final Description transfo=new Description("usine de radiotransmetteur","usines de radiotransmetteur","Une usine de radiotransmetteur procure (5 fois le niveau de l'usine ) unités de systèmes de guidage par tour.");
 public static final Description pharma=new Description("laboratoire pharmaceutique","laboratoires pharmaceutiques","Un laboratoire pharmaceutique procure (5 fois le niveau de l'usine )  unités de médicaments par tour.");
 public static final Description info=new Description("société informatique","sociétés informatiques","Une société informatique procure (5 fois le niveau de l'usine )  unités de logiciels par tour.");
 public static final Description robot=new Description("usine de robotique","usines de robotique","Une usine de robotique procure (5 fois le niveau de l'usine ) unités de robots par tour.");
 public static final Description techno=new Description("technocentre","technocentres","Un technocentre procure (5 fois le niveau de l'usine ) unités de composants électroniques par tour.");
 public static final Description arme=new Description("usines d'armement","usines d'armement","Une usine d'armement procure (5 fois le niveau de l'usine ) unités d'armement et d'explosif par tour.");
 public static final Description raffine=new Description("raffinerie","raffineries","Une raffinerie procure (5 fois le niveau de l'usine ) unités energétique par tour.");
 public static final Description lourde=new Description("industrie lourde","industries lourdes","Une centre industriel procure (5 fois le niveau de l'usine ) unités de pièces industrielles par tour.");
 public static final Description metaux=new Description("usine d'enrichissement","usines d'enrichissement des métaux","Une usine d'enrichissement des métaux procure (5 fois le niveau de l'usine ) unités de métaux précieux par tour.");
