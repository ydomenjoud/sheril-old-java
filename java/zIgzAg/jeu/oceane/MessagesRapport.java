...
public class MessagesRapport extends MessagesAbstraits{
 ...
 public static final String[] RESUME_SYSTEMES={"Résumé de vos systèmes","&nbsp;","Position","Nom","Pop","Pop Max",
                                               "Planètes",
                                               "Taxe","Stabilité","Budget T.","Budget S.","Budget C.",
 ...
 public static final String[] FLOTTES={"Rapport des flottes"," (Pour voir le détail des flottes)","Nom de la flotte",
  ...
  "Capacité maximale ville spatiale","Population présente","Nombre"};
 ...
 public static final String[] STATS_CENTAURES={"Etats des comptes à la Banque Galactique",
 ...
 public static final String[] STATS_UNIVERS_SITES={"Sites des commandants","Sites des alliances","Sites d'Océane"};
